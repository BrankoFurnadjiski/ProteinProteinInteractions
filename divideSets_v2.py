...
# Reading from:
HumanPPI700GO = open("../data/HumanPPI700_GO_v2.txt", "r")
HumanPPI900GO = open("../data/HumanPPI900_GO_v2.txt", "r")
CCGOterms = open("../data/CCGOterms.txt", "r")
MFGOterms = open("../data/MFGOterms.txt", "r")
BPGOterms = open("../data/BPGOterms.txt", "r")

# Writing into:
HumanPPI700GOMF = open("../data/HumanPPI700_GO_MF_v2.txt", "w")
HumanPPI900GOMF = open("../data/HumanPPI900_GO_MF_v2.txt", "w")
HumanPPI700GOCC = open("../data/HumanPPI700_GO_CC_v2.txt", "w")
HumanPPI900GOCC = open("../data/HumanPPI900_GO_CC_v2.txt", "w")
HumanPPI700GOBP = open("../data/HumanPPI700_GO_BP_v2.txt", "w")
HumanPPI900GOBP = open("../data/HumanPPI900_GO_BP_v2.txt", "w")
...
print("(" + time.strftime("%c") + ")  Dividing the HumanPPI700_GO_v2 file...")
...
print("(" + time.strftime("%c") + ")  Dividing the HumanPPI900_GO_v2 file...")
