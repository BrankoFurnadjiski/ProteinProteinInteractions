...
if __name__ == '__main__':
	...
	HumanPPI700GOBP = open("../data/HumanPPI700_GO_BP.txt", "r")
	HumanPPI700GOMF = open("../data/HumanPPI700_GO_MF.txt", "r")
	HumanPPI700GOCC = open("../data/HumanPPI700_GO_CC.txt", "r")
	HumanPPI900GOBP = open("../data/HumanPPI900_GO_BP.txt", "r")
	HumanPPI900GOMF = open("../data/HumanPPI900_GO_MF.txt", "r")
	HumanPPI900GOCC = open("../data/HumanPPI900_GO_CC.txt", "r")

	# Writing from:
	HumanPPI700GOBPmodified = open("../data/HumanPPI700_GO_BP_modified.txt", "w")
	HumanPPI700GOMFmodified = open("../data/HumanPPI700_GO_MF_modified.txt", "w")
	HumanPPI700GOCCmodified = open("../data/HumanPPI700_GO_CC_modified.txt", "w")
	HumanPPI900GOBPmodified = open("../data/HumanPPI900_GO_BP_modified.txt", "w")
	HumanPPI900GOMFmodified = open("../data/HumanPPI900_GO_MF_modified.txt", "w")
	HumanPPI900GOCCmodified = open("../data/HumanPPI900_GO_CC_modified.txt", "w")
