...
for line in GOAHumanHistory:
	...
	if uniprotId not in goAnnotationsPerProteinHistory:
		goAnnotationsPerProteinHistory[uniprotId] = set()

	goAnnotationsPerProteinHistory[uniprotId].add(goId)
...
for line in GOAHumanNow:
	...
	try:	
		...
		if uniprotId not in goAnnotationsPerProteinNow:
			goAnnotationsPerProteinNow[uniprotId] = set()

		goAnnotationsPerProteinNow[uniprotId].add(goId)
	except Exception:
