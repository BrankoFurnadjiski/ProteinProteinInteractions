...
# Reading from:
HumanPPI700GOBPmodified = open("../data/HumanPPI700_GO_BP_modified_v2.txt", "r")
HumanPPI700GOCCmodified = open("../data/HumanPPI700_GO_CC_modified_v2.txt", "r")
HumanPPI700GOMFmodified = open("../data/HumanPPI700_GO_MF_modified_v2.txt", "r")
